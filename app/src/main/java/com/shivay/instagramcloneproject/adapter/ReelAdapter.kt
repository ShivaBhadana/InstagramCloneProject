...
import com.shivay.instagramcloneproject.databinding.ReelDgBinding
...
class ReelAdapter(var context: Context, var reelList: ArrayList<Reel>)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.video.setVideoPath(reelList.get(position).reelUrl)
        holder.binding.video.setOnPreparedListener{
